...
const Header = ({ onNote }) => {
  ...
  const { background, changeBackground, headWallet, setHeadWallet } =
          ...
          <nav className="navbar navbar-expand">
            <div className="collapse navbar-collapse justify-content-between">
              <div className="header-left">
                <div className="input-group search-area">
                  ...
                  <span className="input-group-text">
                    <Link to={"#"}>{SVGICON.SearchIconSvg}</Link>
                  </span>
                </div>
              </div>
              <ul className="navbar-nav header-right ">
                ...
                <Dropdown
                  as="li"
                  className="nav-item notification_dropdown sm-search"
                >
                  <Dropdown.Toggle
                    to={"#"}
                        ...
                        {listBlog.map((data, i) => (
                          <li key={i}>
                            <div className="timeline-panel">
                              <div className="me-2 search-p">{data.icon}</div>
                ...
                <li
                  className={`nav-item dropdown notification_dropdown ${
                    path === "dashboard" || path === "index-2" ? "" : "d-none"
                  }`}
                >
                  <Link
                    to={"#"}
