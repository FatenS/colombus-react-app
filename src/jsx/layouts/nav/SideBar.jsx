...
const SideBar = () => {
  ...
  return (
    <div
      ...
      className={`dlabnav ${
        path === "dashboard" || path === "index-2" ? "follow-info" : ""
      } ${iconHover} ${
        ...
        <div className="dlabnav-scroll">
          ...
          {filteredMenuList.map((data, index) => {
              ...
              if (menuClass === "menu-title") {
                return (
                  <li className={`nav-label ${menuClass}`} key={index}>
                    {data.title}
                  </li>
                );
              } else {
          ...
          {/* <div className="support-box">
            ...
            <div className="info">
              <p>Colombus-Capital Crypto Trading UI Template</p>
              <Link to={"#"} className="btn bg-white text-black w-75 btn-sm">
                Supports
              </Link>
            </div> 
          </div> */}
          {/* <div className="copyright">
            <p>
              <strong>Colombus-Capital Crypto Trading UI Template</strong> ©{" "}
              <span className="current-year">{Latest.getFullYear()}</span> All
              Rights Reserved
            </p>
            <p className="fs-12">
              Made with
