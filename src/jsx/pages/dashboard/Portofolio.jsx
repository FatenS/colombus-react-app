            ...
            <div className="card-body">
              <div className="text-center my-profile">
                ...
                <div className="media-content">
                  <h4 className="mt-3 font-w400 fs-16 text-dark mb-0">
                    Join on 24 March 2020
                  </h4>
                  <p className="my-3">
                    ...
                    <div className="card-body">
                      <div className="align-items-center d-flex justify-content-between">
                        <div className="c-heading">
                          <span className="text-dark font-w600 mb-2 d-block text-nowrap ">
                            345
                          </span>
                          <p className="mb-0 font-w500 text-nowrap">
                            Transactions
                          </p>
                        </div>
                        <div className="d-inline-block position-relative donut-chart-sale mb-0">
                          <DonughtChart
                            backgroundColor="rgba(9, 60, 189, 1)"
                ...
                <div className="col-xl-12  col-sm-12">
                  <div className="card">
                    <div className="card-body">
                      <div className="align-items-center d-flex justify-content-between">
                        <div className="c-heading">
                          <span className="text-dark font-w600 mb-2 d-block">
                            4,563
                          </span>
