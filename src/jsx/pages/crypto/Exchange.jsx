          ...
          <div className="card">
            <div className="card-body pb-2">
              <h1 className="text-center no-border font-w600 fs-60 mt-2">
                <span className="text-success">Buy</span> and{" "}
                <span className="text-danger">Sell</span> Coins at the
                <br /> Colombus-Capital with no additional charges
              </h1>
              ...
              <div className="row">
                <div className="col-xl-12">
                  ...
                  <div className="text-center mt-4 mb-4">
                    <Link
                      to={"/p2p"}
                      className="btn btn-warning mx-auto btn-sm"
                    >
                      EXCHANGE NOW
                    </Link>
                  </div>
                ...
                <div className="card-body py-0 pt-4">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <span className="fs-16 font-w500 text-success ps-2">
                        <i className="bi bi-caret-up-fill pe-2" />
                      </span>
                    </div>
                  </div>
                ...
                <div className="card-body py-0 pt-4">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <span className="fs-16 font-w500 text-danger ps-2">
                        <i className="bi bi-caret-down-fill pe-2" />
                      </span>
                    </div>
                  </div>
                  <div id="paidinvoices">
              ...
              <div className="card">
                ...
                <div className="card-body px-3 py-0">
                  <div className="table-responsive">
                    <table
                      className="table-responsive table shadow-hover tickettable display mb-4 dataTablesCard dataTable no-footer"
                      id="example6"
                    >
                      <thead>
                        <tr>
                        ...
                        {soldTable.map((item, i) => (
                          <tr key={i}>
                            ...
                            <td className="text-end">
                              <span
                                className={`badge badge-sm badge-${item.color}`}
                              >
                                {item.status}
                              </span>
                            </td>
