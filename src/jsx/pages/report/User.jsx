                ...
                <div className="card-body d-flex">
                  <div className="d-block">
                    <img
                      ...
                      className="avatar avatar-xxl border-primary rounded-circle"
                      alt=""
                    />
                  </div>
                  <div className="w-100 ps-4">
                    <div className="d-flex justify-content-between">
                      ...
                      <div className="d-flex">
                        <div className="icon-box icon-box-sm bgl-danger me-2 btn-edit">
                          <Link to={"#"}>{SVGICON.DangerCircle}</Link>
                        </div>
                        <Dropdown className="ms-auto">
                          <Dropdown.Toggle
                            as="div"
                            className="i-false icon-box icon-box-sm bgl-primary"
                          >
                            {SVGICON.EditPencil}
                          </Dropdown.Toggle>
                          <Dropdown.Menu
                    ...
                    <div className="d-flex flex-wrap pt-4">
                      <div className="d-flex align-items-center pe-md-4 pe-2 mb-2">
                        <div className="pe-2">{SVGICON.MailBoxSvg}</div>
                        <h5 className="font-w400 mb-0">demo@gmail.com</h5>
                      </div>
                      <div className="d-flex align-items-center pe-md-4 pe-2 mb-2">
                        <div className="pe-2">{SVGICON.CallIconSvg}</div>
                        <h5 className="font-w400 mb-0">+012 345 689</h5>
                      </div>
                      <div className="d-flex align-items-center pe-md-4 pe-2 mb-2">
                        <div className="pe-2">{SVGICON.UserContact}</div>
                        <h5 className="font-w400 mb-0">
                          Colombus-Capital Studios
                        </h5>
                      </div>
                    </div>
                  </div>
              ...
              <div className="card">
                <div className="card-header border-0 pb-0 d-block">
                  <div className="d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <span>
                        You have <strong className="text-primary">456</strong>{" "}
                        contacts
                      </span>
                    </div>
                  ...
                  <div className="input-group custom-search-area mt-3">
                    <span className="input-group-text">
                      <Link to={"#"}>{SVGICON.SearchBoldIcon}</Link>
                    </span>
                    <input
                      type="text"
                ...
                <div className="card-body pt-4 pb-0 height370 dlab-scroll">
                  <div className="contacts-list" id="RecentActivityContent">
                    {datas &&
                      datas.map((item, i) => (
                        <div
                          className="d-flex justify-content-between my-3 border-bottom-dashed pb-3"
                          key={i}
                        >
                          <div className="d-flex align-items-center">
                            ...
                            <div className="ms-3">
                              <h5 className="mb-1">
                                <Link to="/app-profile">{item.name}</Link>
                              </h5>
                ...
                <div className="card-footer border-0 pt-0">
                  <div className="text-center border-0">
                    <Link
                      to={"#"}
                      className="btn btn-block btn-primary btn-sm dlab-load-more"
              ...
              <div className="card">
                <div className="card-header d-block border-0 pb-0 ">
                  <div className="d-flex justify-content-between">
                    <div>
                      ...
                      <span>
                        You have{" "}
                        <strong className="text-primary">10 New</strong>{" "}
                        Messages
                      </span>
                    </div>
                    <Link
                      to={"#"}
                      className="icon-box icon-box-sm bg-primary"
                ...
                <div className="card-body height370 dlab-scroll pt-4 pb-0">
                  <div className="contacts-list" id="RecentMessagesContent">
                    {datas &&
                      datas.map((item, i) => (
                        <div
                          className="d-flex justify-content-between mb-3 mt-3 border-bottom-dashed pb-3"
                          key={i}
                        >
                          <div className="d-flex align-items-center">
                            <img src={item.image} alt="" className="avatar" />
                            <div className="ms-3">
                              <h5 className="mb-1">
                                <Link to="/email-inbox">{item.name}</Link>
                              </h5>
                ...
                <div className="card-footer border-0 pt-0">
                  <div className="text-center border-0 pt-3">
                    <Link
                      to={"#"}
                      className="btn btn-block btn-primary dlab-load-more btn-sm"
                      onClick={() => hendelClick("two")}
                    >
                      View More {refreshIcon && <i className="fa fa-refresh" />}
                    </Link>
                  </div>
                </div>
              </div>
                ...
                <div className="prot-blog">
                  <div className="d-flex post justify-content-between align-items-center">
                    <div className="d-flex align-items-center mb-2">
                      <h5 className="text-white card-title mb-0 me-3">
                        Current Plan
                      </h5>
                  ...
                  <h4 className="mb-0">
                    <Link to="/post-details" className="text-bla">
                      {SVGICON.WhiteDot} 250 GB Storage
                    </Link>
                  </h4>
                  <h4 className="mb-3">
                    <Link to="/post-details" className="text-bla">
                      {SVGICON.WhiteDot} Unlimited Tickets Support
                    </Link>
                  </h4>
                  <Link to="#" className="btn btn-sm btn-secondary btn-sm">
                    Upgrade Plan
                  </Link>
                  <div className="shape">{SVGICON.ShapeUser}</div>
                </div>
              </div>
            </div>
            <div className="col-xl-12 col-lg-6 ">
                ...
                <div className="card-body pt-2">
                  {taskData.map((data, i) => (
                    <div className="d-flex align-items-center mb-4" key={i}>
                      ...
                      <div className="ms-3">
                        <h5 className="mb-1">
                          <Link to={"#"} className={`text-${data.color}`}>
                            {data.name}
                          </Link>
                        </h5>
                        <ul className="d-flex">
                    ...
                    <ul className="timeline-active">
                          ...
                          >
                            <h4 className="mb-0">
                              ...
                              <strong className="text-primary">
                                Colombus-Capital Projects
                              </strong>{" "}
                            </h4>
                          </Link>
                          <span className="time py-0">
                            Monday, June 31 2020
                          </span>
                        </div>
                      </li>
                      <li className="d-flex timeline-list">
                        ...
                        <div className="panel">
                          ...
                          >
                            <h4 className="mb-0">
                              <strong>Tony Soap </strong> commented at{" "}
                              <strong className="text-primary">
                                {" "}
                                Colombus-Capital Projects{" "}
                              </strong>
                        ...
                        <div className="panel">
                          ...
                          >
                            <h4 className="mb-0">
                              ...
                              Colombus-Capital{" "}
                              <strong className="text-danger">Projects </strong>
                            </h4>
                          </Link>
                          <span className="time py-0">
                            Monday, June 31 2020
