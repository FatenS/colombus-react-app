...
const marketDataTable = [
  ...
  },
  {
    ...
    volume: "20,110.00",
    cap: "Loss",
    logo: SVGICON.AustralianDoller,
    name: "AUD",
    subtitle: "Australian Doller",
    change: "+11",
  },
  {
    price: "$0.5332",
  ...
  },
  {
    ...
    volume: "50,580.00",
    cap: "Loss",
    logo: SVGICON.EtheriumDoller,
    name: "ETH",
    subtitle: "Etherium Classic",
    change: "-09",
  },
  {
    price: "$0.4112",
...
const FutureTab = () => {
  ...
  const [data, setData] = useState(
    document.querySelectorAll("#future_table tbody tr")
  );
  ...
  useEffect(() => {
    setData(document.querySelectorAll("#future_table tbody tr"));
  }, [test]);
      ...
      case "change":
        sortedPeople.sort((a, b) => {
          return iconData.complete
            ...
            : b.change.localeCompare(a.change);
        });
        break;
      case "highlow":
        sortedPeople.sort((a, b) => {
          return iconData.complete
            ? a.highlow.localeCompare(b.highlow)
            : b.highlow.localeCompare(a.highlow);
        });
        break;
      case "volume":
        sortedPeople.sort((a, b) => {
          return iconData.complete
            ...
            : b.volume.localeCompare(a.volume);
        });
        break;
      case "cap":
        sortedPeople.sort((a, b) => {
  ...
  return (
    <div className="table-responsive dataTabletrade">
      <div id="future_table" className="dataTables_wrapper no-footer">
        <table
          id="example-history"
          className="table shadow-hover display  orderbookTable dataTable no-footer"
            ...
            {marketData.map((item, i) => (
              <tr key={i}>
                <td>
                  ...
                  >
                    <div
                      className={`market-icon bg-${
                        item.name === "Dash" ? "success" : "warning"
                      } `}
                    >
                      {item.logo}
                    </div>
